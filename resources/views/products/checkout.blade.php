...
<form method="POST" action="{{ route('pay') }}" id="paymentForm">
    ...
    <input type="hidden" name="country" value="TZ" /> <!-- Replace the value with your transaction country -->
    <input type="hidden" name="currency" value="TZS" /> <!-- Replace the value with your transaction currency -->
    <input type="hidden" name="email" value="info@afrikan.store" /> <!-- Replace the value with your customer email -->
    <input type="hidden" name="firstname" value="Paul" /> <!-- Replace the value with your customer firstname -->
    <input type="hidden" name="lastname" value="Mandele" /> <!-- Replace the value with your customer lastname -->
